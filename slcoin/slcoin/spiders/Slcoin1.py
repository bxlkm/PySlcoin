...
class SlcoinSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in range(0, 100):
            if coin_type[i] == 'BTC-比特币' or coin_type[i] == 'ETH-以太坊' or coin_type[i] == 'EOS-柚子' or coin_type[i] == 'LTC-莱特币' or \
                    coin_type[i] == 'XMR-门罗币' or coin_type[i] == 'NEO-小蚁' or coin_type[i] == 'ETC-以太经典' or coin_type[i] == 'OMG-嫩模币' or\
                    coin_type[i] == 'BNB-币安币' or \
                    coin_type[i] == 'HT-火币积分' or coin_type[i] == 'ZEC-大零币' or coin_type[i] == 'DCR' or coin_type[i] == 'MKR' or \
                    coin_type[i] == 'REP' or coin_type[i] == 'GXS-公信宝' or coin_type[i] == 'EMC-崛起币' or coin_type[i] == 'ZEN' or \
